  ...
  const OrderCard = ({ order }: { order: any }) => (
    <Card className="maritime-card maritime-card-glow">
      ...
      <CardContent className="space-y-3">
        ...
        {order.nft_token_id && order.nft_contract_address && (<a href={`https://explorer-sepolia.inkonchain.com/token/${order.nft_contract_address}/instance/${order.nft_token_id}`} target="_blank" rel="noopener noreferrer" className="block mt-2 w-full"><Button variant="outline" className="w-full maritime-button bg-[#1E3A5F] hover:bg-[#D4AF37] hover:text-[#0A192F] text-[#CCD6F6] border border-[#D4AF37]/50 font-serif">See NFT contract (ink-scan)</Button></a>)}
